...
public class PantryUser {
    ...
    public PantryUser(Long id, String username, String email, String password, UserRole role) {
        this.userId = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PantryUser)) return false;
        if (!super.equals(object)) return false;
        PantryUser user = (PantryUser) object;
